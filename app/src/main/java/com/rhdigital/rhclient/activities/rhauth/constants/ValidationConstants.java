...
public class ValidationConstants {
  ...
  public static int VALIDATION_STRATEGY_SIGN_IN_EMAIL = 3;
  ...
  private static final HashMap<String, List<String>> VALIDATION_STRATEGY_SIGN_IN_EMAIL_MAP;
  static {
    VALIDATION_STRATEGY_SIGN_IN_EMAIL_MAP = new HashMap<>();
    VALIDATION_STRATEGY_SIGN_IN_EMAIL_MAP.put("email", Arrays.asList("textValidation", "emailValidation"));
    VALIDATION_STRATEGY_SIGN_IN_EMAIL_MAP.put("password", Arrays.asList("textValidation"));
  }
  ...
  static {
    ...
    VALIDATION_STRATEGY_MAP.put(VALIDATION_STRATEGY_SIGN_IN_EMAIL, VALIDATION_STRATEGY_SIGN_IN_EMAIL_MAP);
